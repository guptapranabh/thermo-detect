...
iface_video = gr.Interface(
    ...
    title="Thermal Imaging Malfunction Detector",
    description="Upload videos for inference to detect anomalies. The video will be displayed as a GIF along with a description of detected objects and issues.",
)
